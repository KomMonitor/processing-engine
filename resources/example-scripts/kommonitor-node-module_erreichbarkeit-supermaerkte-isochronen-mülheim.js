...
async function computeIndicator(targetDate, targetSpatialUnit_geoJSON, baseIndicatorsMap, georesourcesMap, processParameters){
  ...
  var supermaerkteFeatures = KmHelper.getGeoresourceById("95b1daaf-e0e9-48b9-ac2d-9ded575646f7", georesourcesMap);
  ...
  var supermaerkte = supermaerkteFeatures.features;
