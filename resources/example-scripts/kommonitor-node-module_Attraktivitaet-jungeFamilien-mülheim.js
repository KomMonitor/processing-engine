...
async function computeIndicator(targetDate, targetSpatialUnit_geoJSON, baseIndicatorsMap, georesourcesMap, processParameters){
  ...
  var supermaerkte = KmHelper.getBaseIndicatorById('3095be64-73c3-4afd-b265-5737b9ffa146', baseIndicatorsMap);
  var freiraum = KmHelper.getBaseIndicatorById('364ebf6c-e047-4f11-88c9-eef48dac666e', baseIndicatorsMap);
  var grundschulen = KmHelper.getBaseIndicatorById('61126369-7c0b-42b5-a9f8-0fe071d1adbe', baseIndicatorsMap);
  var kitas = KmHelper.getBaseIndicatorById('501a3ec5-5d8c-47e3-9997-f76d8a1307ce', baseIndicatorsMap);
  var spielplaetze = KmHelper.getBaseIndicatorById('ac8f9610-3351-43d2-b5e2-887798d7a355', baseIndicatorsMap);
