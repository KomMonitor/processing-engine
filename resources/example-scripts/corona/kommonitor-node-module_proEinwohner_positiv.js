...
const covidStatusIndicatorId = "48a18455-6a52-4e74-bdbf-99237187fc5c";
const habitantsIndicatorId = "362a498e-66ca-4996-aec6-835a8810ece1";
...
async function computeIndicator(targetDate, targetSpatialUnit_geoJSON, baseIndicatorsMap, georesourcesMap, processParameters){
      ...
      */
      habitantsGeoJSON.features.forEach(function(feature) {
        ...
        var einwohnerzahl = KmHelper.getIndicatorValue(feature, targetDate_habitants);

        if(einwohnerzahl === undefined || einwohnerzahl === null){
          KmHelper.log("WARNING: the feature with featureID '" + featureId + "' does not contain a time series value for targetDate '" + targetDate_habitants + "'");
